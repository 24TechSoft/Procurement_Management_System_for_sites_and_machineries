<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="CreateIndent.aspx.cs" Inherits="Admin_CreateIndent" %>
...
<tr valign="top"><td>
            Select Site<br />
            <asp:DropDownList ID="ddlSiteCustomer" runat="server" AutoPostBack="true" 
                OnSelectedIndexChanged="ddlSiteCustomer_SelectedIndexChanged" Width="200px" CssClass="form-control">
            </asp:DropDownList>
            </td>
            <td>
            Project No <a href="Projects.aspx" target="_blank">Add New</a><br />
            ...
            <td>
            Job No <a href="Projects.aspx" target="_blank">Add New</a><br />
