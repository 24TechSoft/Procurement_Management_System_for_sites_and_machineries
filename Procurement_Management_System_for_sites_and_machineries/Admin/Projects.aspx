<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="Projects.aspx.cs" Inherits="Admin_Projects" %>

<asp:Content ID="Content1" ContentPlaceHolderID="CPH1" Runat="Server">
<div class="container">
    <div class="row">
        <div class="col-lg-3 col-md-6 col-sm-12">
    Select Site:<asp:DropDownList ID="ddlSite" runat="server" OnSelectedIndexChanged="ddlSite_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
        </div>
...
<AlternatingRowStyle CssClass="TableRowClass" />
