	...
	<div class="fixed-box">
		<div class="row">
			<div class="col-md-12">
                ...
                <div class="col-md-10 col-md-offset-1">
                     <div class="col-xs-2">
                            <asp:Label ID="lblTotalIndents" runat="server" Text="0" CssClass="btn"></asp:Label>
                    </div>
                     <div class="col-xs-10">
                            <a href="SiteIndent.aspx" class="btn btn-sm btn-primary btn-block">&nbsp; New Indents</a>
                     </div>
				</div>
                <div class="col-md-10 col-md-offset-1">
                     <div class="col-xs-2">
                         <asp:Label ID="lblTotalRenewal" runat="server" Text="0" CssClass="btn"></asp:Label>
                    </div>
                     <div class="col-xs-10">
                         <a class="btn btn-sm btn-primary btn-block" href="AdminRenewalAlerts.aspx">&nbsp; New Renewal Alerts</a>
                    </div>
				</div>
				<div class="col-md-10 col-md-offset-1">
                    <div class="col-xs-2">
