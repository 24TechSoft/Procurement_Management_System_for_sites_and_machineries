<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="MachineDamageReport.aspx.cs" Inherits="Admin_MachineDamageReport" %>
...
<tr valign="top"><td>
<label>Site</label><br />
<asp:DropDownList ID="ddlSite" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlSite_SelectedIndexChanged" Width="200px"></asp:DropDownList></td>
<td>
...
<tr><td colspan="3"><br /></td></tr>
<tr><td colspan="3"><asp:Button ID="btnExportToPDF" runat="server" Text="Export To PDF" 
