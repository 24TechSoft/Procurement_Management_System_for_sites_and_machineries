<%@ Page Title="Indent" Language="C#" MasterPageFile="~/WorkshopIncharge/Worker.master" AutoEventWireup="true" CodeFile="Indent.aspx.cs" Inherits="Admin_Indent" %>
...
<asp:GridView ID="grdIndent" runat="server" AutoGenerateColumns="False" 
 DataKeyNames="ID"
        GridLines="Horizontal" Width="100%" onrowdeleting="grdIndent_RowDeleting" Font-Size="Small">
