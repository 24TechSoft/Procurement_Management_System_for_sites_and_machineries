<%@ Page Title="" Language="C#" MasterPageFile="~/WorkshopIncharge/Worker.master" AutoEventWireup="true" CodeFile="CurrentStock.aspx.cs" Inherits="Admin_CurrentStock" %>
...
<asp:GridView ID="grdParts" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
        GridLines="Horizontal" OnRowDeleting="grdParts_RowDeleting" 
        ...
        BorderColor="#33CCCC" Font-Size="Small" Width="100%">
