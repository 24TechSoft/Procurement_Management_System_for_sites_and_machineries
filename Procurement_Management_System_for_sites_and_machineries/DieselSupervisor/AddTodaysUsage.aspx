<%@ Page Title="" Language="C#" MasterPageFile="Supervisor.master" AutoEventWireup="true" CodeFile="AddTodaysUsage.aspx.cs" Inherits="Admin_AddTodaysUsage" %>
...
<td><label>Fuel Balance</label><br />
...
<tr><td colspan="3"><br /></td></tr>
<tr><td colspan="3">
<!-- EntryDate, SiteID, SiteMachineID, StartingReading, ClosingReading, WorkingHours, Idle, BD, AvailableHours, HSDLub, EOLub, HOLub, GoLub, OtherLub, HSDOil, UOM, CurrentLocation, TotalProduction, Remarks, Status, EnteredBy-->
<asp:GridView ID="grd" runat="server" AutoGenerateColumns="false" GridLines="Both" Font-Size="XX-Small" Width="100%">
