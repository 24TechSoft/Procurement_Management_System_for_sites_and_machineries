<%@ Page Title="" Language="C#" MasterPageFile="Supervisor.master" AutoEventWireup="true" CodeFile="UserProfile.aspx.cs" Inherits="Supervisor_UserProfile" %>
...
<asp:DropDownList ID="ddlUserType" runat="server" CssClass="form-control" Width="150px" Enabled="false">
...
<asp:DropDownList ID="ddlSite" runat="server" CssClass="form-control" Width="200px" Enabled="false"></asp:DropDownList>
</div>
<div class="form-group">
