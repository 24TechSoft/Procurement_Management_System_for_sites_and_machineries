<%@ Page Title="" Language="C#" MasterPageFile="Supervisor.master" AutoEventWireup="true" CodeFile="Machines.aspx.cs" Inherits="Supervisor_Machines" %>
...
<asp:GridView ID="grdMachines" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
        GridLines="Horizontal" Width="100%" EnableModelValidation="True" OnRowDeleting="grdMachines_RowDeleting"  BorderStyle="Inset"
        BorderColor="#33CCCC" Font-Size="Small">
...
<asp:BoundField HeaderText="Status Updated Date" DataField="UpdateDate" />
...
<asp:ListItem Value="2" Text="Under Maintenance"></asp:ListItem>
